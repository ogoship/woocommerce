...
# The Connect button targets the production API. Define OGOSHIP_API_BASE in wp-config.php to point
# it somewhere else -- an ngrok tunnel, say, when driving a local Ecom.
